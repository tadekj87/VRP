...
void Greedy(int Rozmiar, int K, int baza)
{
    ...
    {   // jesteśmy w pierwszym wierszu
        ...
        limit = true;
        k++;
        cout << "Razem" << obliczPermutacje() << " " << endl;
    }
}
...
double obliczPermutacje(int rozmiar, int tablicaOblicz[])
{
    ...
    suma += tablica[rozmiar - 1][0];  //powrót do bazy
    //cout << endl << "dodawanie: " << suma << endl;
    return suma;
}

double symulowaneWyzarzanie(int rozmiar)
{
    ...
    int pomoc = tablicaSW[24];  //prosta zamiana bazy z 0 na...
    tablicaSW[24] = tablicaSW[0];
    tablicaSW[0] = pomoc;
...
int main()
{
    ...
    double wynikWyzarzania = 0;
    wynikWyzarzania = symulowaneWyzarzanie(rozmiar);

    cout << endl << "Wynik wyzarzania to: " << wynikWyzarzania << " " << jednostka << endl;
